...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cms_page', (
            ...
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='updated_pages', null=True, to=orm['auth.User'])),
        ))
    ...
    models = {
        ...
        'cms.page': {
            ...
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'updated_pages'", 'null': 'True', 'to': "orm['auth.User']"})
        },
