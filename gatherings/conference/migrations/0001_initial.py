...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Room'
        db.create_table('conference_room', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('conference', ['Room'])

        # Adding model 'Session'
        db.create_table('conference_session', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('room', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.Room'], null=True, blank=True)),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Room'
        db.delete_table('conference_room')
